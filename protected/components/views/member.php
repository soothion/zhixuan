<div class="userProfileContainer clearfix">
    ...
    <div class="userProfileDescribe">
        <div class="userTitleSection"> <span class="snsEntLink"><a href="#"><img src="images/T1.png" /></a><a href="#"><img src="images/T2.png" /></a></span> <span class="lab"><?php if ($user->level == 1) echo '普通';if ($user->level == 2) echo '高级'; ?>会员</span> <span class="name"> <?php echo $user->username ?></span> </div>
